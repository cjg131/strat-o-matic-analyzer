...
export function LineupOptimizerPage() {
  ...
  // Optimized lineup vs LHSP - Favor righties/switch when stats are close
  // Top hitters: Gwynn, Chance, Rodriguez stay. Swap Suzuki (L) for McGee (S), keep Thomas/Lansford (R)
  const vsLHSPLineup: LineupSlot[] = [
    ...
    { position: 6, playerId: '6', playerName: 'Matsui, K. (2007)', pos: '2B', def: '2e6', bal: '3', simBA: 0.288, simOBP: 0.342, simSLG: 0.405, realBA: 0.288, realOBP: 0.342, realSLG: 0.405, backup1: '', backup2: '', platoonPH: 'Gordon, D.' },
    { position: 7, playerId: '7', playerName: 'McGee, W. (1988)', pos: 'CF', def: '1(0)e12', bal: '1', simBA: 0.292, simOBP: 0.329, simSLG: 0.372, realBA: 0.292, realOBP: 0.329, realSLG: 0.372, backup1: '', backup2: '', platoonPH: 'Suzuki, I.' },
  ...
  // Optimized lineup vs RHSP - Feature left-handed batters more prominently
  // Suzuki and Gordon get starting spots over McGee and Bowa
      ...
      <div className="space-y-6">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
          <p className="text-sm text-blue-800 dark:text-blue-200">
            <strong>Optimized Lineups:</strong> Top 3 (Gwynn, Chance, Rodriguez) stay in both lineups due to elite stats. <strong>vs LHSP:</strong> Uses McGee (S) and Bowa (S) over Suzuki (L) and Gordon (L) for platoon advantage. <strong>vs RHSP:</strong> Features Suzuki (L) and Gordon (L) to exploit lefty-righty matchup. Both optimized by OPS with strategic platoon adjustments.
          </p>
        </div>
