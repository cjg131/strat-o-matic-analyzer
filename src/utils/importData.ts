        ...
        jsonData.forEach((row: any, index: number) => {
          try {
            ...
            const hitter: Hitter = {
              ...
              fieldingRange,
              fieldingError,
              stealRating: normalizedRow.stl || normalizedRow.stealrating || normalizedRow.steal || undefined,
              runRating: normalizedRow.run || normalizedRow.runrating || normalizedRow.running || undefined,
              ab,
